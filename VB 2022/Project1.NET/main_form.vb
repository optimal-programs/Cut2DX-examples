...
Friend Class main_form
    ...
    Private Sub RegisterToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RegisterToolStripMenuItem.Click
        register_form.tbComputerID.Text = CStr(Optimization2DX1.ComputerID)
        If register_form.ShowDialog() = Windows.Forms.DialogResult.OK Then
            Optimization2DX1.RegisterOptimization2DX(register_form.tbName.Text, register_form.tbSerialNumber.Text)
        End If
    End Sub
    Private Sub AboutToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles AboutToolStripMenuItem.Click
        about_form.l_Version.Text = "Cut 2D X version:" + CStr(Optimization2DX1.Version)
